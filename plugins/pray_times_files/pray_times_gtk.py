...
class LocationDialog(Gtk.Dialog):
    ...
    def __init__(self, maxResults=200):
        ...
        ###############
        hbox = Gtk.HBox()
        hbox.pack_start(Gtk.Label(_('Search Cities:')), 0, 0, 0)
        entry = Gtk.Entry()
        ...
        hbox.pack_start(self.lowerLabel, 1, 1, 0)
...
class TextPlugUI:
    def makeWidget(self):
        ...
        hbox.pack_start(self.locButton, 0, 0, 0)
        self.confDialog.vbox.pack_start(hbox, 0, 0, 0)
        ###
        hbox = Gtk.HBox()
        ...
        hbox.pack_start(self.methodCombo, 0, 0, 0)
        self.confDialog.vbox.pack_start(hbox, 0, 0, 0)
        #######
        treev = Gtk.TreeView()
        treev.set_headers_clickable(False)
        ...
        frame.add(treev)
        self.confDialog.vbox.pack_start(frame, 0, 0, 0)
        ######
        hbox = Gtk.HBox()
        hbox.pack_start(Gtk.Label(_('Imsak')), 0, 0, 0)
        spin = Gtk.SpinButton()
        ...
        self.imsakSpin = spin
        hbox.pack_start(spin, 0, 0, 0)
        hbox.pack_start(Gtk.Label(' '+_('minutes before fajr')), 0, 0, 0)
        self.confDialog.vbox.pack_start(hbox, 0, 0, 0)
        ######
        hbox = Gtk.HBox()
        hbox.pack_start(Gtk.Label(_('Seperator')), 0, 0, 0)
        ...
        hbox1.pack_start(self.preAzanEnableCheck, 0, 0, 0)
        ...
        hbox2.pack_start(self.preAzanFileButton, 1, 1, 0)
        hbox2.pack_start(Gtk.Label('  '), 0, 0, 0)
        ##
        spin = Gtk.SpinButton()
        spin.set_increments(1, 5)
        ...
        ##
        hbox2.pack_start(Gtk.Label('  '), 0, 0, 0)
        hbox2.pack_start(Gtk.Label(_('minutes before azan')), 0, 0, 0)
        hbox1.pack_start(hbox2, 1, 1, 0)
        vboxFrame.pack_start(hbox1, 0, 0, 0)
        #####
        hbox1 = Gtk.HBox()
        ...
        #####
        hbox1 = Gtk.HBox()
        self.playerCombo = Gtk.ComboBoxText.new_with_entry()
        hbox1.pack_start(Gtk.Label(_('Player')), 0, 0, 0)
        hbox1.pack_start(Gtk.Label('  '), 0, 0, 0)
        hbox1.pack_start(self.playerCombo, 0, 0, 0)
        hbox1.pack_start(Gtk.Label(''), 1, 1, 0)
        vboxFrame.pack_start(hbox1, 0, 0, 0)
        #####
        frame.add(vboxFrame)
        hbox.pack_start(frame, 1, 1, 0)
    ...
    def updateConfWidget(self):
        ...
        self.playerCombo.get_child().set_text(self.playerName)
    def updateConfVars(self):
        ...
        ##
        self.playerName = self.playerCombo.get_child().get_text()
