...
class ListPrefItem(PrefItem):
    ...
    def append(self, item):
        self._widget.pack_start(item._widget, 0, 0, 0)
...
class ToolbarIconSizePrefItem(PrefItem):
    ...
    def get(self):
        return iconSizeList[self._widget.get_active()][0]
    def set(self, value):
...
class AICalsPrefItem():
    def __init__(self):
        ...
        ###
        swin = treev.makeSwin()
        self._widget.pack_start(swin, 1, 1, 0)
        ####
        ...
        toolbar.insert(tb, -1)
        ##
        self._widget.pack_start(toolbar, 0, 0, 0)
        ########
